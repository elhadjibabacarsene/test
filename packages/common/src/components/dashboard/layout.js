...
export const VuroxBody = (props) => (
  <div
    className={
      props.className +
      ' vurox-dark-version vurox-fixed-position vurox-admin-template'
    }
  >
    {props.children}
  </div>
...
export const VuroxComponentsContainer = (props) => {
  return (
    <div
      className={
        props.className +
        ' rounded vurox-admin-primary-bg vurox-admin-components-block overview-hidden'
      }
      style={{ backgroundColor: props.fillbg }}
    >
      {props.children}
    </div>
  );
